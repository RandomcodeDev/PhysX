function setup_physx(physx_root, fix_target, group, warnings)
    ...
    target("PhysXVehicle")
        set_kind("static")
        add_headerfiles(
            path.join(physx_root, "include", "vehicle", "PxVehicleComponents.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleDrive.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleDrive4W.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleDriveNW.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleDriveTank.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleNoDrive.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleSDK.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleShaders.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleTireFriction.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleUpdate.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleUtil.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleUtilControl.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleUtilSetup.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleUtilTelemetry.h"),
            path.join(physx_root, "include", "vehicle", "PxVehicleWheels.h"),

            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleLinearMath.h"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSerialization.h"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSuspLimitConstraintShader.h"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSuspWheelTire4.h"),

            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "include", "PxVehicleAutoGeneratedMetaDataObjectNames.h"),
            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "include", "PxVehicleAutoGeneratedMetaDataObjects.h"),
            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "include", "PxVehicleMetaDataObjects.h")
        )
        add_files(
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleComponents.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleDrive.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleDrive4W.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleDriveNW.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleDriveTank.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleMetaData.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleNoDrive.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSDK.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSerialization.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleSuspWheelTire4.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleTireFriction.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleUpdate.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "PxVehicleWheels.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "VehicleUtilControl.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "VehicleUtilSetup.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "VehicleUtilTelemetry.cpp"),

            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "src", "PxVehicleAutoGeneratedMetaDataObjects.cpp"),
            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "src", "PxVehicleMetaDataObjects.cpp")
        )
        ...
        add_includedirs(
            ...
            path.join(physx_root, "source", "physxvehicle", "src"),
            path.join(physx_root, "source", "physxvehicle", "src", "physxmetadata", "include"),
    ...
    target("PhysXVehicle2")
        set_kind("static")
        add_headerfiles(
            path.join(physx_root, "include", "vehicle2", "PxVehicleAPI.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleComponent.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleComponentSequence.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleLimits.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleParams.h"),
            path.join(physx_root, "include", "vehicle2", "PxVehicleMaths.h"),

            path.join(physx_root, "include", "vehicle2", "braking", "PxVehicleBrakingFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "braking", "PxVehicleBrakingParams.h"),

            path.join(physx_root, "include", "vehicle2", "commands", "PxVehicleCommandHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "commands", "PxVehicleCommandParams.h"),
            path.join(physx_root, "include", "vehicle2", "commands", "PxVehicleCommandStates.h"),

            path.join(physx_root, "include", "vehicle2", "drivetrain", "PxVehicleDrivetrainComponents.h"),
            path.join(physx_root, "include", "vehicle2", "drivetrain", "PxVehicleDrivetrainFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "drivetrain", "PxVehicleDrivetrainHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "drivetrain", "PxVehicleDrivetrainParams.h"),
            path.join(physx_root, "include", "vehicle2", "drivetrain", "PxVehicleDrivetrainStates.h"),

            path.join(physx_root, "include", "vehicle2", "physxActor", "PxVehiclePhysXActorComponents.h"),
            path.join(physx_root, "include", "vehicle2", "physxActor", "PxVehiclePhysXActorFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "physxActor", "PxVehiclePhysXActorHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "physxActor", "PxVehiclePhysXActorStates.h"),

            path.join(physx_root, "include", "vehicle2", "physxConstraints", "PxVehiclePhysXConstraintComponents.h"),
            path.join(physx_root, "include", "vehicle2", "physxConstraints", "PxVehiclePhysXConstraintFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "physxConstraints", "PxVehiclePhysXConstraintHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "physxConstraints", "PxVehiclePhysXConstraintParams.h"),
            path.join(physx_root, "include", "vehicle2", "physxConstraints", "PxVehiclePhysXConstraintStates.h"),

            path.join(physx_root, "include", "vehicle2", "physxRoadGeometry", "PxVehiclePhysXRoadGeometryComponents.h"),
            path.join(physx_root, "include", "vehicle2", "physxRoadGeometry", "PxVehiclePhysXRoadGeometryFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "physxRoadGeometry", "PxVehiclePhysXRoadGeometryHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "physxRoadGeometry", "PxVehiclePhysXRoadGeometryParams.h"),
            path.join(physx_root, "include", "vehicle2", "physxRoadGeometry", "PxVehiclePhysXRoadGeometryState.h"),

            path.join(physx_root, "include", "vehicle2", "rigidBody", "PxVehicleRigidBodyComponents.h"),
            path.join(physx_root, "include", "vehicle2", "rigidBody", "PxVehicleRigidBodyFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "rigidBody", "PxVehicleRigidBodyParams.h"),
            path.join(physx_root, "include", "vehicle2", "rigidBody", "PxVehicleRigidBodyStates.h"),

            path.join(physx_root, "include", "vehicle2", "roadGeometry", "PxVehicleRoadGeometryState.h"),

            path.join(physx_root, "include", "vehicle2", "steering", "PxVehicleSteeringFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "steering", "PxVehicleSteeringParams.h"),

            path.join(physx_root, "include", "vehicle2", "suspension", "PxVehicleSuspensionComponents.h"),
            path.join(physx_root, "include", "vehicle2", "suspension", "PxVehicleSuspensionFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "suspension", "PxVehicleSuspensionParams.h"),
            path.join(physx_root, "include", "vehicle2", "suspension", "PxVehicleSuspensionStates.h"),
            path.join(physx_root, "include", "vehicle2", "suspension", "PxVehicleSuspensionHelpers.h"),

            path.join(physx_root, "include", "vehicle2", "tire", "PxVehicleTireComponents.h"),
            path.join(physx_root, "include", "vehicle2", "tire", "PxVehicleTireFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "tire", "PxVehicleTireHelpers.h"),
            path.join(physx_root, "include", "vehicle2", "tire", "PxVehicleTireParams.h"),
            path.join(physx_root, "include", "vehicle2", "tire", "PxVehicleTireStates.h"),

            path.join(physx_root, "include", "vehicle2", "wheel", "PxVehicleWheelComponents.h"),
            path.join(physx_root, "include", "vehicle2", "wheel", "PxVehicleWheelFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "wheel", "PxVehicleWheelParams.h"),
            path.join(physx_root, "include", "vehicle2", "wheel", "PxVehicleWheelStates.h"),
            path.join(physx_root, "include", "vehicle2", "wheel", "PxVehicleWheelHelpers.h"),

            path.join(physx_root, "include", "vehicle2", "pvd", "PxVehiclePvdComponents.h"),
            path.join(physx_root, "include", "vehicle2", "pvd", "PxVehiclePvdFunctions.h"),
            path.join(physx_root, "include", "vehicle2", "pvd", "PxVehiclePvdHelpers.h"),

            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdAttributeHandles.h"),
            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdObjectHandles.h"),
            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdWriter.h")
        )

        add_files(
            path.join(physx_root, "source", "physxvehicle2", "src", "commands", "VhCommandHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "drivetrain", "VhDrivetrainFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "drivetrain", "VhDrivetrainHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "physxActor", "VhPhysXActorFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "physxActor", "VhPhysXActorHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "physxConstraints", "VhPhysXConstraintFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "physxConstraints", "VhPhysXConstraintHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "physxRoadGeometry", "VhPhysXRoadGeometryFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "physxRoadGeometry", "VhPhysXRoadGeometryHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "rigidBody", "VhRigidBodyFunctions.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "steering", "VhSteeringFunctions.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "suspension", "VhSuspensionFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "suspension", "VhSuspensionHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "tire", "VhTireFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "tire", "VhTireHelpers.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "wheel", "VhWheelFunctions.cpp"),

            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdHelpers.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdFunctions.cpp"),
            path.join(physx_root, "source", "physxvehicle2", "src", "pvd", "VhPvdWriter.cpp")
        )
    ...
    target("SceneQuery")
        set_kind("static")
        add_headerfiles(
            path.join(physx_root, "source", "scenequery", "src", "include", "SqFactory.h"),
            path.join(physx_root, "source", "scenequery", "src", "include", "SqPruner.h"),
            path.join(physx_root, "source", "scenequery", "src", "include", "SqPrunerData.h"),
            path.join(physx_root, "source", "scenequery", "src", "include", "SqManager.h"),
            path.join(physx_root, "source", "scenequery", "src", "include", "SqQuery.h"),
            path.join(physx_root, "source", "scenequery", "src", "include", "SqTypedef.h"),

            path.join(physx_root, "source", "scenequery", "src", "SqCompoundPruner.h"),
            path.join(physx_root, "source", "scenequery", "src", "SqCompoundPruningPool.h")
        )
        add_files(
            path.join(physx_root, "source", "scenequery", "src", "SqFactory.cpp"),
            path.join(physx_root, "source", "scenequery", "src", "SqCompoundPruner.cpp"),
            path.join(physx_root, "source", "scenequery", "src", "SqCompoundPruningPool.cpp"),
            path.join(physx_root, "source", "scenequery", "src", "SqManager.cpp"),
            path.join(physx_root, "source", "scenequery", "src", "SqQuery.cpp")
        )
    ...
    target("SimulationController")
        set_kind("static")
        add_headerfiles(
            path.join(physx_root, "source", "simulationcontroller", "include", "ScActorCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationJointCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationSensor.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScBodyCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScBroadphase.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScConstraintCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScIterators.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScPhysics.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScRigidCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScScene.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScShapeCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScSqBoundsSync.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScStaticCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScSoftBodyCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScFEMClothCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScHairSystemCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScParticleSystemCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationTendonCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationAttachmentCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "include", "ScArticulationTendonJointCore.h"),

            path.join(physx_root, "source", "simulationcontroller", "src", "ScActorPair.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScActorSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationJointSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationTendonSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationSensorSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSoftBodySim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSoftBodyShapeSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFEMClothSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFEMClothShapeSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFiltering.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemShapeCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemShapeSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemShapeCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemShapeSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScBodySim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintInteraction.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScContactReportBuffer.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScContactStream.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScElementInteractionMarker.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScElementSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScElementSimInteraction.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScInteraction.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScInteractionFlags.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScNPhaseCore.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScObjectIDTracker.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScRigidSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeInteraction.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeSimBase.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSimStateData.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSimStats.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSimulationController.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSqBoundsManager.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScStaticSim.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScTriggerInteraction.h"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScTriggerPairs.h")
        )
        add_files(
            path.join(physx_root, "source", "simulationcontroller", "src", "ScActorCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScActorSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationJointCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationTendonCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationJointSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationTendonJointCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationTendonSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScArticulationSensorSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScBroadphase.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSoftBodyCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSoftBodySim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSoftBodyShapeSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFEMClothCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFEMClothSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFEMClothShapeSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScFiltering.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemShapeCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScParticleSystemShapeSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemShapeCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScHairSystemShapeSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScBodyCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScBodySim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintBreakage.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintInteraction.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScConstraintSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScElementInteractionMarker.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScElementSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScInteraction.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScIterators.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScKinematics.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScMetaData.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScNPhaseCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScPhysics.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScRigidCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScRigidSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScScene.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScCCD.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeInteraction.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeSim.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScShapeSimBase.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSimStats.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSimulationController.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSqBoundsManager.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScStaticCore.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScTriggerInteraction.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScVisualize.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScSleep.cpp"),
            path.join(physx_root, "source", "simulationcontroller", "src", "ScPipeline.cpp")
        )
